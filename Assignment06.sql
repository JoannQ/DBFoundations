...
-- 2022-11-18,QJoann,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_QJoann')
	 Begin 
	  Alter Database [Assignment06DB_QJoann] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_QJoann;
	 End
	Create Database Assignment06DB_QJoann;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_QJoann;
...
-- Here is an example of some rows selected from the view:
-- CategoryID	  CategoryName	ProductID	ProductName	        UnitPrice	InventoryID	InventoryDate	Count	EmployeeID	Em ployee
